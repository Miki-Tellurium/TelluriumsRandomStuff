...
public class ModRecipeSerializers {
    public static final RegistryObject<RecipeSerializer<SoulLavaTransmutationRecipe>> SOUL_LAVA_TRANSMUTATION = registerSerializer(ModRecipeTypes.SOUL_LAVA_TRANSMUTATION, () -> SoulLavaTransmutationRecipe.Serializer.INSTANCE);
    public static final RegistryObject<RecipeSerializer<SoulInfusionRecipe>> SOUL_INFUSION = registerSerializer(ModRecipeTypes.SOUL_INFUSION, () -> SoulInfusionRecipe.Serializer.INSTANCE);
    public static final RegistryObject<RecipeSerializer<CompactingRecipe>> COMPACTING = registerSerializer(ModRecipeTypes.COMPACTING, () -> CompactingRecipe.Serializer.INSTANCE);
