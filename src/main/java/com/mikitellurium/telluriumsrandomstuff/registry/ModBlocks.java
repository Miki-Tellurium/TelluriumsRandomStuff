...
public class ModBlocks {
    ...
    public static final RegistryObject<LiquidBlock> SOUL_LAVA_BLOCK = registerBlock("soul_lava_block",
            () -> new SoulLavaBlock(ModFluids.SOUL_LAVA_SOURCE), false);
    ...
    public static final RegistryObject<Block> SOUL_LAVA_CAULDRON = registerBlock("soul_lava_cauldron",
            SoulLavaCauldronBlock::new, false);
    ...
    public static final RegistryObject<Block> POTTED_BRIGHT_TORCHFLOWER = registerBlock("potted_bright_torchflower",
            () -> new FlowerPotBlock(() -> (FlowerPotBlock)Blocks.FLOWER_POT, BRIGHT_TORCHFLOWER,
                    BlockBehaviour.Properties.copy(Blocks.POTTED_TORCHFLOWER).lightLevel((blockState) -> 15)), false);

    public static final RegistryObject<Block> BRIGHT_TORCHFLOWER_CROP = registerBlock("bright_torchflower_crop",
            BrightTorchflowerCropBlock::new, false);
    ...
    public static final RegistryObject<Block> POTTED_SOUL_TORCHFLOWER = registerBlock("potted_soul_torchflower",
            () -> new FlowerPotBlock(() -> (FlowerPotBlock)Blocks.FLOWER_POT, SOUL_TORCHFLOWER,
                    BlockBehaviour.Properties.copy(Blocks.POTTED_TORCHFLOWER).lightLevel((blockState) -> 15)), false);

    public static final RegistryObject<Block> SOUL_TORCHFLOWER_CROP = registerBlock("soul_torchflower_crop",
            SoulTorchFlowerCropBlock::new, false);
    ...
    public static final RegistryObject<Block> BLUE_REDSTONE_LAMP = registerBlock("blue_redstone_lamp",
            () -> new RedstoneLampBlock(BlockBehaviour.Properties.copy(Blocks.REDSTONE_LAMP)));

    public static final RegistryObject<Block> AWAKENED_SCULK_SHRIEKER = registerBlock("awakened_sculk_shrieker",
    ...
    public static final RegistryObject<Block> STONE_ITEM_PEDESTAL = registerBlock("stone_item_pedestal",
            () -> new ItemPedestalBlock(BlockBehaviour.Properties.copy(Blocks.STONE)));

    public static final RegistryObject<Block> STONE_BRICK_ITEM_PEDESTAL = registerBlock("stone_brick_item_pedestal",
            () -> new ItemPedestalBlock(BlockBehaviour.Properties.copy(Blocks.STONE_BRICKS)));

    public static final RegistryObject<Block> MOSSY_STONE_BRICK_ITEM_PEDESTAL = registerBlock("mossy_stone_brick_item_pedestal",
            () -> new ItemPedestalBlock(BlockBehaviour.Properties.copy(Blocks.MOSSY_STONE_BRICKS)));

    public static final RegistryObject<Block> POLISHED_GRANITE_ITEM_PEDESTAL = registerBlock("polished_granite_item_pedestal",
            () -> new ItemPedestalBlock(BlockBehaviour.Properties.copy(Blocks.POLISHED_GRANITE)));

    public static final RegistryObject<Block> POLISHED_DIORITE_ITEM_PEDESTAL = registerBlock("polished_diorite_item_pedestal",
            () -> new ItemPedestalBlock(BlockBehaviour.Properties.copy(Blocks.POLISHED_DIORITE)));

    public static final RegistryObject<Block> POLISHED_ANDESITE_ITEM_PEDESTAL = registerBlock("polished_andesite_item_pedestal",
            () -> new ItemPedestalBlock(BlockBehaviour.Properties.copy(Blocks.POLISHED_ANDESITE)));

    public static final RegistryObject<Block> POLISHED_DEEPSLATE_ITEM_PEDESTAL = registerBlock("polished_deepslate_item_pedestal",
            () -> new ItemPedestalBlock(BlockBehaviour.Properties.copy(Blocks.POLISHED_DEEPSLATE)));

    public static final RegistryObject<Block> DEEPSLATE_BRICK_ITEM_PEDESTAL = registerBlock("deepslate_brick_item_pedestal",
            () -> new ItemPedestalBlock(BlockBehaviour.Properties.copy(Blocks.DEEPSLATE_BRICKS)));

    public static final RegistryObject<Block> DEEPSLATE_TILE_ITEM_PEDESTAL = registerBlock("deepslate_tile_item_pedestal",
            () -> new ItemPedestalBlock(BlockBehaviour.Properties.copy(Blocks.DEEPSLATE_TILES)));

    public static final RegistryObject<Block> CUT_SANDSTONE_ITEM_PEDESTAL = registerBlock("cut_sandstone_item_pedestal",
            () -> new ItemPedestalBlock(BlockBehaviour.Properties.copy(Blocks.CUT_SANDSTONE)));

    public static final RegistryObject<Block> CUT_RED_SANDSTONE_ITEM_PEDESTAL = registerBlock("cut_red_sandstone_item_pedestal",
            () -> new ItemPedestalBlock(BlockBehaviour.Properties.copy(Blocks.CUT_RED_SANDSTONE)));

    public static final RegistryObject<Block> PRISMARINE_BRICK_ITEM_PEDESTAL = registerBlock("prismarine_brick_item_pedestal",
            () -> new ItemPedestalBlock(BlockBehaviour.Properties.copy(Blocks.PRISMARINE_BRICKS)));

    public static final RegistryObject<Block> NETHER_BRICK_ITEM_PEDESTAL = registerBlock("nether_brick_item_pedestal",
            () -> new ItemPedestalBlock(BlockBehaviour.Properties.copy(Blocks.NETHER_BRICKS)));

    public static final RegistryObject<Block> RED_NETHER_BRICK_ITEM_PEDESTAL = registerBlock("red_nether_brick_item_pedestal",
            () -> new ItemPedestalBlock(BlockBehaviour.Properties.copy(Blocks.RED_NETHER_BRICKS)));

    public static final RegistryObject<Block> POLISHED_BLACKSTONE_ITEM_PEDESTAL = registerBlock("polished_blackstone_item_pedestal",
            () -> new ItemPedestalBlock(BlockBehaviour.Properties.copy(Blocks.POLISHED_BLACKSTONE)));

    public static final RegistryObject<Block> POLISHED_BLACKSTONE_BRICK_ITEM_PEDESTAL = registerBlock("polished_blackstone_brick_item_pedestal",
            () -> new ItemPedestalBlock(BlockBehaviour.Properties.copy(Blocks.POLISHED_BLACKSTONE_BRICKS)));

    public static final RegistryObject<Block> END_STONE_BRICK_ITEM_PEDESTAL = registerBlock("end_stone_brick_item_pedestal",
            () -> new ItemPedestalBlock(BlockBehaviour.Properties.copy(Blocks.END_STONE_BRICKS)));

    public static final RegistryObject<Block> PURPUR_ITEM_PEDESTAL = registerBlock("purpur_item_pedestal",
            () -> new ItemPedestalBlock(BlockBehaviour.Properties.copy(Blocks.PURPUR_BLOCK)));

    public static final RegistryObject<Block> QUARTZ_ITEM_PEDESTAL = registerBlock("quartz_item_pedestal",
            () -> new ItemPedestalBlock(BlockBehaviour.Properties.copy(Blocks.QUARTZ_BLOCK)));

    public static final RegistryObject<Block> SOUL_MAGMA_BRICK_ITEM_PEDESTAL = registerBlock("soul_magma_brick_item_pedestal",
            () -> new ItemPedestalBlock(BlockBehaviour.Properties.copy(SOUL_MAGMA_BRICKS.get())));

    public static final RegistryObject<Block> OPAL_ITEM_PEDESTAL = registerBlock("opal_item_pedestal",
            () -> new ItemPedestalBlock(BlockBehaviour.Properties.copy(OPAL.get())));

    public static final RegistryObject<Block> OPAL_BRICK_ITEM_PEDESTAL = registerBlock("opal_brick_item_pedestal",
            () -> new ItemPedestalBlock(BlockBehaviour.Properties.copy(OPAL_BRICKS.get())));

    public static final RegistryObject<Block> CUT_OPAL_BRICK_ITEM_PEDESTAL = registerBlock("cut_opal_brick_item_pedestal",
            () -> new ItemPedestalBlock(BlockBehaviour.Properties.copy(CUT_OPAL_BRICKS.get())));

    public static final RegistryObject<Block> INFUSED_SOUL_SAND = registerBlock("infused_soul_sand",
    ...
    public static final RegistryObject<Item> SOUL_INFUSER_LIT = ModRegistries.ITEMS.register("soul_infuser_lit",
            () -> new Item(new Item.Properties()));

    public static final RegistryObject<Block> ALCHEMIXER = registerBlock("alchemixer",
            AlchemixerBlock::new);

    public static final RegistryObject<Block> SOUL_COMPACTOR = registerBlock("soul_compactor",
            SoulCompactorBlock::new);
    public static final RegistryObject<Item> SOUL_COMPACTOR_LIT = ModRegistries.ITEMS.register("soul_compactor_lit",
            () -> new Item(new Item.Properties()));
