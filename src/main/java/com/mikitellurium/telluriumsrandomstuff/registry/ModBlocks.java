...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> CUT_OPAL_BRICKS = registerBlock("cut_opal_bricks", () -> new RGBTintedBlock(BlockBehaviour.Properties.copy(Blocks.STONE)));
    ...
    public static final RegistryObject<Block> CRACKED_CUT_OPAL_BRICKS = registerBlock("cracked_cut_opal_bricks", () -> new RGBTintedBlock(BlockBehaviour.Properties.copy(Blocks.STONE)));
    ...
    public static final RegistryObject<Block> CUT_OPAL_BRICK_SLAB = registerBlock("cut_opal_brick_slab", () -> new RGBTintedSlabBlock(BlockBehaviour.Properties.copy(Blocks.COBBLESTONE)));
    ...
    public static final RegistryObject<Block> CRACKED_CUT_OPAL_BRICK_SLAB = registerBlock("cracked_cut_opal_brick_slab", () -> new RGBTintedSlabBlock(BlockBehaviour.Properties.copy(Blocks.COBBLESTONE)));
    ...
    public static final RegistryObject<Block> CUT_OPAL_BRICK_STAIRS = registerBlock("cut_opal_brick_stairs", () -> new RGBTintedStairBlock(Blocks.STONE::defaultBlockState, BlockBehaviour.Properties.copy(Blocks.STONE)));
    ...
    public static final RegistryObject<Block> CUT_OPAL_BRICK_WALL = registerBlock("cut_opal_brick_wall", () -> new RGBTintedWallBlock(BlockBehaviour.Properties.copy(Blocks.STONE)));
    ...
    public static final RegistryObject<Block> CUT_OPAL_BRICK_ITEM_PEDESTAL = registerBlock("cut_opal_brick_item_pedestal", () -> new RGBTintedItemPedestalBlock(BlockBehaviour.Properties.copy(CUT_OPAL_BRICKS.get()).noOcclusion()));
