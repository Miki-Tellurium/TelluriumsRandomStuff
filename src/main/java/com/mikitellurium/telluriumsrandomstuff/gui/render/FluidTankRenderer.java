...
public class FluidTankRenderer {
    ...
    private static void drawTextureWithMasking(Matrix4f matrix, float x, float y, TextureAtlasSprite textureSprite, long maskTop, long maskRight, float zLevel) {
        ...
        bufferBuilder.vertex(matrix, x, y + 16, zLevel).uv(uMin, vMax).endVertex();
        bufferBuilder.vertex(matrix,x + 16 - maskRight, y + 16, zLevel).uv(uMax, vMax).endVertex();
        bufferBuilder.vertex(matrix,x + 16 - maskRight, y + maskTop, zLevel).uv(uMax, vMin).endVertex();
        bufferBuilder.vertex(matrix, x, y + maskTop, zLevel).uv(uMin, vMin).endVertex();
        tessellator.end();
    }
