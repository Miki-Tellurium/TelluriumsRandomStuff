...
public class ModTranslationProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        addBlock(ModBlocks.OPAL_TILES_SLAB, "Cut Opal Brick Slab");
        addBlock(ModBlocks.CRACKED_OPAL_BRICK_SLAB, "Cracked Opal Brick Slab");
        addBlock(ModBlocks.CRACKED_OPAL_TILES_SLAB, "Cracked Cut Opal Brick Slab");
        ...
        addBlock(ModBlocks.OPAL_TILES_STAIRS, "Cut Opal Brick Stairs");
        addBlock(ModBlocks.OPAL_COBBLESTONE_WALL, "Opal Cobblestone Wall");
        addBlock(ModBlocks.OPAL_BRICK_WALL, "Opal Brick Wall");
        addBlock(ModBlocks.OPAL_TILES_WALL, "Cut Opal Brick Wall");
        ...
        addBlock(ModBlocks.OPAL_TILES_ITEM_PEDESTAL, "Cut Opal Brick Item Pedestal");
